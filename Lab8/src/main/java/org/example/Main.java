...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            messageHandler.printInfo("=================== TEST 1 ===================");
            testWorkMethod(workService, messageHandler);
            messageHandler.printInfo("=================== TEST 2 ===================");
            testRunMethod(runService, messageHandler);
        } catch (InterruptedException e) {
            messageHandler.printError("Произошла ошибка: Этот поток был прерван");
        } catch (Exception e) {
            messageHandler.printError("Произошла ошибка: " + e.getMessage());
        }
    }
